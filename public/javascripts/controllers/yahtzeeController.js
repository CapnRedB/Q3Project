...
app.controller( 'yahtzeeCtrl', [ '$scope', '$firebaseArray', '$firebaseObject', function( $scope, $firebaseArray, $firebaseObject ) {
	...
	// $scope.view.player1.uppersubtotal = 0;
	...
	$scope.updateFirstPlayerUpperScore = function(scoreToUpdate){
		console.log("Called");
		console.log($scope.view.player1[scoreToUpdate]);
		$scope.view.player1[scoreToUpdate]+=1;
		$scope.view.player1.uppersubtotal=parseInt($scope.view.player1.aces + $scope.view.player1.twos + $scope.view.player1.threes + $scope.view.player1.fours + $scope.view.player1.fives + $scope.view.player1.sixes);
		console.log($scope.view.player1.uppersubtotal);
		console.log($scope.view.player1.twos);
	}
